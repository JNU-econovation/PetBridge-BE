...
public enum MemberErrorType implements ErrorType {
    MEMBER_NOT_FOUND_EXCEPTION ("Member400_001", HttpStatus.NOT_FOUND, "해당하는 멤버를 찾을 수 없습니다"),
    INVALID_EMAIL_OR_PASSWORD_EXCEPTION("Member400_002",HttpStatus.NOT_FOUND, "이메일이나 비밀번호가 틀렸습니다");
